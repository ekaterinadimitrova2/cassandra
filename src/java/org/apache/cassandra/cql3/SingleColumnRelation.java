...
public final class SingleColumnRelation extends Relation
{
    ...
    private SingleColumnRelation(ColumnIdentifier column, Term.Raw mapKey, Operator operator, Term.Raw value, Terms.Raw inValues)
    {
    ...
    protected Restriction newINRestriction(TableMetadata table, VariableSpecifications boundNames)
    {
        ...
        // An IN restrictions with only one element is the same as an EQ restriction
