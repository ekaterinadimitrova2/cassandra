...
public final class ColumnCondition
{
    ...
    public static class Raw
    {
        ...
        {
            return new Raw(ColumnsExpression.Raw.singleColumn(column), collectionElement, null, op, values);
        }
        ...
        {
            return new Raw(ColumnsExpression.Raw.singleColumn(column), null, udtField, op, values);
        }
        ...
        public ColumnCondition prepare(TableMetadata table)
        {
            ...
            ColumnMetadata receiver = table.getExistingColumn(expression.columnSpecification().name);
