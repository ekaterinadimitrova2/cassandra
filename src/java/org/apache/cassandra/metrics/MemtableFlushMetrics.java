...
public class MemtableFlushMetrics
{
    ...
    {
        numPendingTasks = Metrics.register(factory.createMetricName("PendingTasks"),
                                           () -> (long) MemtableCleanerThread.Clean.numPendingTasks());
    }
}
