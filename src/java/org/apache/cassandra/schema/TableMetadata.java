...
public final class TableMetadata
{
    ...
    public Iterator<ColumnMetadata> allColumnsInSelectOrder()
    {
        return new AbstractIterator<ColumnMetadata>()
        {
            ...
            private final Iterator<ColumnMetadata> clusteringIter = clusteringColumns.iterator();
            private final Iterator<ColumnMetadata> otherColumns = regularAndStaticColumns.selectOrderIterator();
