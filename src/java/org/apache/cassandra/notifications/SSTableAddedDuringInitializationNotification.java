...
public class SSTableAddedDuringInitializationNotification implements INotification
{
    ...
    public SSTableAddedDuringInitializationNotification(Iterable<SSTableReader> added)
    {
        this.added = added;
    }
}
