...
public class ParseAndConvertUnits
{
    ...
    // This function helps to support expected behavior of parameters which should be of type int/double/long but
    // currently they are parsed to String.
    // Blank throws an exception and commented out parameter means zero.
