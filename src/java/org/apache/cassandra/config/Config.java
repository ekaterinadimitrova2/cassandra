...
public class Config
{
    ...
    public static final Duration otc_coalescing_window_us_default = new Duration("200US");
    @Replaces(oldName = "otc_coalescing_window_us", deprecated = true)
    public Duration outbound_connection_coalescing_window = otc_coalescing_window_us_default;
