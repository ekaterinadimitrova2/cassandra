...
public class Config
{
    ...
    public volatile int columns_per_table_abort_threshold = DISABLED_GUARDRAIL;
    public volatile int secondary_indexes_per_table_warn_threshold = DISABLED_GUARDRAIL;
    public volatile int secondary_indexes_per_table_abort_threshold = DISABLED_GUARDRAIL;
    public volatile int materialized_views_per_table_warn_threshold = DISABLED_GUARDRAIL;
    public volatile int materialized_views_per_table_abort_threshold = DISABLED_GUARDRAIL;
    public volatile int page_size_warn_threshold = DISABLED_GUARDRAIL;
    public volatile int page_size_abort_threshold = DISABLED_GUARDRAIL;
