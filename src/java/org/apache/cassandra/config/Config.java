...
public class Config
{
    ...
    public volatile DataStorageSpec column_index_cache_size = new DataStorageSpec("2KiB");
    @Replaces(oldName = "batch_size_warn_threshold_in_kb", converter = Converters.KIBIBYTES_DATASTORAGE, deprecated = true)
    public volatile DataStorageSpec batch_size_warn_threshold = new DataStorageSpec("5KiB");
