...
public class Config
{
    ...
    @Replaces(oldName = "otc_coalescing_strategy", scheduledRemoveBy = "6.0")
    ...
    @Replaces(oldName = "otc_coalescing_window_us", scheduledRemoveBy = "6.0")
    public static final int otc_coalescing_window_us_default = 200;
    public int outbound_connection_coalescing_window_us = otc_coalescing_window_us_default;

    @Replaces(oldName = "outbound_connection_coalescing_enough_coalesced_messages", scheduledRemoveBy = "6.0")
