...
public class Config
{
    ...
    public static final CassandraDuration otc_coalescing_window_us_default = new CassandraDuration("200US");
    @Replaces(oldName = "otc_coalescing_window_us", deprecated = true)
    public CassandraDuration outbound_connection_coalescing_window = otc_coalescing_window_us_default;
