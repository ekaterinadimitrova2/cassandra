...
public class JMXServerUtils
{
    ...
    {
        Map<String, Object> env = new HashMap<>();
        if (!SysPropertiesConfig.isRequiredMgmtJMXRemoteAuth())
            return env;
    ...
    {
        Map<String, Object> env = new HashMap<>();
        if (SysPropertiesConfig.isJMXRemoteMonitoringSSL())
        {
            boolean requireClientAuth = SysPropertiesConfig.isRequiredClientAuth();
            String[] protocols = null;
            String protocolList = SysPropertiesConfig.getProtocolList();
            ...
            String[] ciphers = null;
            String cipherList = SysPropertiesConfig.getCipherList();
            if (cipherList != null)
            {
