...
public interface MemtableCleaner
{
     ...
     *
     * @param minOwnershipRatio The minimum quantity of memory that should be cleaned. Below this ratio, no cleaning
     *                          is required.
     */
    CompletableFuture<Boolean> clean(double minOwnershipRatio);
}
