...
public class AuditLogOptions extends BinLogOptions
{
    ...
    public static class Builder
    {
        ...
        {
            final AuditLogOptions sanitised = sanitise(defaultOptions);
            this.enabled = sanitised.enabled;
            this.logger = sanitised.logger;
            this.includedKeyspaces = sanitised.included_keyspaces;
            this.excludedKeyspaces = sanitised.excluded_keyspaces;
            this.includedCategories = sanitised.included_categories;
            this.excludedCategories = sanitised.excluded_categories;
            this.includedUsers = sanitised.included_users;
            this.excludedUsers = sanitised.excluded_users;
            this.auditLogDir = sanitised.audit_logs_dir;
            this.maxQueueWeight = sanitised.max_queue_weight;
            this.maxArchiveRetries = sanitised.max_archive_retries;
            this.rollCycle = sanitised.roll_cycle;
            this.archiveCommand = sanitised.archive_command;
            this.block = sanitised.block;
            this.maxLogSize = sanitised.max_log_size;
        }
        ...
        private static AuditLogOptions sanitise(final AuditLogOptions other)
        {
            ...
            sanitise(other.roll_cycle).map(v -> options.roll_cycle = v.toUpperCase());
