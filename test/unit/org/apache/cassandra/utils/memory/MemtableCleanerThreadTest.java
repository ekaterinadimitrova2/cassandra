...
import org.apache.cassandra.metrics.MemtableFlushMetrics;
...
public class MemtableCleanerThreadTest
{
    ...
    MemtableCleanerThread<MemtablePool> cleanerThread;

    MemtableFlushMetrics metric = new MemtableFlushMetrics();
    ...
    private void waitForPendingTasks()
    {
        ...
        for (int i = 0; i < TIMEOUT_MILLIS; i++)
            FBUtilities.sleepQuietly(1);

        assertEquals(Long.valueOf(0), metric.numPendingTasks.getValue());
    }
    ...
    public void testCleanerInvoked() throws Exception
    {
        ...
        assertEquals(Long.valueOf(1), metric.numPendingTasks.getValue());
