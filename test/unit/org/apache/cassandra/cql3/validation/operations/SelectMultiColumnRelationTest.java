...
public class SelectMultiColumnRelationTest extends CQLTester
{
    ...
    public void testMultiClusteringInvalidQueries() throws Throwable
    {
        ...
        assertInvalidMessage("Expected 2 elements in value tuple (b,c), but got 3: (?, ?, ?)",
        ...
        assertInvalidMessage("Expected 3 elements in value tuple (b,c,d), but got 2: (?, ?)",
                             "SELECT * FROM %s WHERE a=0 AND (b, c, d) IN ((?, ?))", 0, 1);
        assertInvalidMessage("Expected 3 elements in value tuple (b,c,d), but got 5: (?, ?, ?, ?, ?)",
