...
public class DescribeStatementTest extends CQLTester
{
    ...
    public void testNotReturningDuplicates() throws Throwable
    {
        ...
        schemaChange("CREATE KEYSPACE ks1 WITH REPLICATION = {'class' : 'SimpleStrategy', 'replication_factor' : 1};");
        ...
        schemaChange("CREATE KEYSPACE ks0 WITH REPLICATION = {'class' : 'SimpleStrategy', 'replication_factor' : 1};");
