...
import org.apache.cassandra.config.SmallestDataStorage;
...
public abstract class CQLTester
{
    ...
    protected static final long ROW_CACHE_SIZE_IN_MIB = new SmallestDataStorage.Mebibytes(System.getProperty("cassandra.test.row_cache_size", "0MiB")).toMebibytes();
