...
public class SnapshotManifestTest
{
    ...
    public void testSerializeAndDeserialize() throws Exception {
        SnapshotManifest manifest = new SnapshotManifest(Arrays.asList("db1", "db2", "db3"), new DurationSpec.LongNanosecondsBound("2m"), Instant.ofEpochMilli(currentTimeMillis()));
        File manifestFile = new File(tempFolder.newFile("manifest.json"));
