...
public class ParseAndConvertUnitsTest
{
    ...
    public void testConfigurationLoaderParser()
    {
        ...
        assertEquals(new SmallestDuration.Milliseconds(0), config.commitlog_sync_group_window);
        ...
        assertEquals(new SmallestDuration.IntSeconds(3600), config.validation_preview_purge_head_start);
