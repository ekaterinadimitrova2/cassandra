...
public class ParseAndConvertUnitsTest
{
    ...
    public void testConfigurationLoaderParser()
    {
        ...
        assertEquals(new SmallestDuration.IntMilliseconds(0), config.commitlog_sync_group_window);
        ...
        assertEquals(SmallestDuration.IntSeconds.inSecondsString("4h"), config.key_cache_save_period);
        assertEquals(new SmallestDuration.IntSeconds(30), config.cache_load_timeout);
        assertEquals(new SmallestDuration.Milliseconds(1500), config.user_defined_functions_fail_timeout);
        assertEquals(new SmallestDuration.Milliseconds(500), config.user_defined_functions_warn_timeout);
        ...
        assertEquals(new DataRateSpec.IntMebibytesPerSecond(0), config.compaction_throughput);
        assertEquals(new DataRateSpec.IntMebibytesPerSecond(23841858), config.stream_throughput_outbound);
        assertEquals(new DataRateSpec.IntMebibytesPerSecond(24), config.inter_dc_stream_throughput_outbound);
    }
}
