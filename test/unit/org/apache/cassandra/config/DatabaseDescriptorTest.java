...
public class DatabaseDescriptorTest
{
    ...
    public void testLowestAcceptableTimeouts() throws ConfigurationException
    {
        ...
        SmallestDuration.Milliseconds greaterThanLowestTimeout = new SmallestDuration.Milliseconds(DatabaseDescriptor.LOWEST_ACCEPTED_TIMEOUT.toMilliseconds() + 1);
        ...
        SmallestDuration.Milliseconds lowerThanLowestTimeout = new SmallestDuration.Milliseconds(DatabaseDescriptor.LOWEST_ACCEPTED_TIMEOUT.toMilliseconds() - 1);
