...
public class DataRateSpecTest
{
    ...
    public void testOverflowingDuringConversion()
    {
        ...
        assertThatThrownBy(() -> new DataRateSpec.IntMebibytesPerSecondBound("2147483648MiB/s")).isInstanceOf(ConfigurationException.class)
                                                                                                .hasMessageContaining("Invalid data rate: 2147483648MiB/s. " +
                                                                                                                 "It shouldn't be more than 2147483646 in mebibytes_per_second");
        assertThatThrownBy(() -> new DataRateSpec.IntMebibytesPerSecondBound(2147483648L)).isInstanceOf(ConfigurationException.class)
                                                                                          .hasMessageContaining("Invalid data rate: 2.147483648E9 mebibytes_per_second. " +
                                                                                                                            "It shouldn't be more than 2147483646 in mebibytes_per_second");

        assertThatThrownBy(() -> new DataRateSpec.IntMebibytesPerSecondBound((Integer.MAX_VALUE * 1024L + 1L) + "KiB/s")).isInstanceOf(ConfigurationException.class)
                                                                                                                         .hasMessageContaining("Invalid data rate: 2199023254529KiB/s. " +
                                                                                                                                          "It shouldn't be more than 2147483646 in mebibytes_per_second");
        assertThatThrownBy(() -> new DataRateSpec.IntMebibytesPerSecondBound((Integer.MAX_VALUE * 1024L * 1024 + 1L) + "B/s")).isInstanceOf(ConfigurationException.class)
                                                                                                                              .hasMessageContaining("Invalid data rate: 2251799812636673B/s. " +
                                                                                                                                               "It shouldn't be more than 2147483646 in mebibytes_per_second");
        assertThatThrownBy(() -> DataRateSpec.IntMebibytesPerSecondBound.megabitsPerSecondInMebibytesPerSecond(2147483648L)).isInstanceOf(ConfigurationException.class)
    ...
    {
        assertThatThrownBy(() -> new DataRateSpec.LongBytesPerSecondBound("10")).isInstanceOf(ConfigurationException.class)
                                                                                .hasMessageContaining("Invalid data rate: 10");
        assertThatThrownBy(() -> new DataRateSpec.LongBytesPerSecondBound("-10b/s")).isInstanceOf(ConfigurationException.class)
                                                                                    .hasMessageContaining("Invalid data rate: -10b/s");
        assertThatThrownBy(() -> new DataRateSpec.LongBytesPerSecondBound("10xb/s")).isInstanceOf(ConfigurationException.class)
    ...
    public void testInvalidForConversion()
    {
        ...
        assertThatThrownBy(() -> new DataRateSpec.LongBytesPerSecondBound(Long.MAX_VALUE + "MiB/s")).isInstanceOf(ConfigurationException.class)
                                                                                                    .hasMessageContaining("Invalid data rate: 9223372036854775807MiB/s. " +
                                                                                               "It shouldn't be more than 9223372036854775806 in bytes_per_second");
        assertThatThrownBy(() -> new DataRateSpec.LongBytesPerSecondBound(Long.MAX_VALUE - 5 + "KiB/s")).isInstanceOf(ConfigurationException.class)
