...
public class LoadOldYAMLBackwardCompatibilityTest
{
    ...
    public void testConfigurationLoaderBackwardCompatibility()
    {
        ...
        assertEquals(SmallestDataStorage.IntMebibytes.inMebibytes(50), config.min_free_space_per_drive);
        ...
        assertEquals(SmallestDataStorage.IntMebibytes.inMebibytes(128), config.max_hints_file_size);
        ...
        assertEquals(SmallestDuration.IntMinutes.inMinutes(60), config.index_summary_resize_interval);
